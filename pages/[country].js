...
const defaultCData = {//default country data
  capital: '',
  pop: '',
  cur: '',
  langs: '',
...
const CountryInfo = ({ history=[] }) => {
  ...
  return (
    <div className={layout.main}>
      ...
      <div className={layout.spacingBottom}>
        <img
          className={layout.flagImage}
      ...
      />
      <div>
        <div className={cn(typo.headingLg, layout.spacingBottom)}>Bordering Countries</div>
